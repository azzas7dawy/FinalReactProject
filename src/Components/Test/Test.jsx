...
// import CourseSection from "../Home/opencourse";
...
//   const [selectedVideo, setSelectedVideo] = useState(null); // لحفظ الفيديو المحدد
...
//     setSelectedVideo(courseId); // حفظ الفيديو الذي تم اختياره
//     navigator("/opencourse", { state: { videoId: courseId } });
//   };

//   const closeVideo = () => {
//     setSelectedVideo(null); // إغلاق الفيديو
//   };
...
//             <div className="card shadow-sm" onClick={() => handleCardClick(course.id || "https://www.youtube.com/embed/Z2ZgGiAmaa4")}>
             
//               <video
//                 src={course.image || course.video} // استخدام صورة افتراضية إذا لم توجد صورة
//                 alt={course.name||"https://youtu.be/Z2ZgGiAmaa4?si=yjVueKSiQd6Y7GZo"}
//                  controls
//                  autoPlay
...
//           <navigator  onClick={CourseSection}></navigator>
//         </div>
//       )}
